...
// Muhammad Luqman Bin Zainon @ Mohd Rastam (1191100953)
public class NewPropertyPage extends javax.swing.JPanel {       //View class for Added New Property Page, generated using NetBeans
    ...
    private void initComponents() {
        ...
        sidebarPanel = new javax.swing.JPanel();
        homeButton_1 = new javax.swing.JButton();
        rentRequestsButton_1 = new javax.swing.JButton();
        managePropertiesButton_1 = new javax.swing.JButton();
        newPropertyPageButton_1 = new javax.swing.JButton();
        logOutButton_1 = new javax.swing.JButton();
        titleLabel = new javax.swing.JLabel();
        selectProjectLabel = new javax.swing.JLabel();
        propertyNameLabel = new javax.swing.JLabel();
        priceLabel = new javax.swing.JLabel();
        ...
        homeButton_1.setBackground(new Color(236, 77, 55));
        homeButton_1.setFont(new java.awt.Font("Source Serif Pro Black", 0, 25)); // NOI18N
        homeButton_1.setForeground(new java.awt.Color(255, 255, 255));
        homeButton_1.setText("Home");
        homeButton_1.setBorder(null);
 

        rentRequestsButton_1.setBackground(new Color(236, 77, 55));
        rentRequestsButton_1.setFont(new java.awt.Font("Source Serif Pro Black", 0, 25)); // NOI18N
        rentRequestsButton_1.setForeground(new java.awt.Color(255, 255, 255));
        rentRequestsButton_1.setText("Rent requests");
        rentRequestsButton_1.setBorder(null);


        managePropertiesButton_1.setBackground(new Color(236, 77, 55));
        managePropertiesButton_1.setFont(new Font("Source Serif Pro Black", Font.PLAIN, 23)); // NOI18N
        managePropertiesButton_1.setForeground(new java.awt.Color(255, 255, 255));
        managePropertiesButton_1.setText("Manage Properties");
        managePropertiesButton_1.setBorder(null);

        newPropertyPageButton_1.setBackground(new Color(236, 77, 55));
        newPropertyPageButton_1.setFont(new java.awt.Font("Source Serif Pro Black", 0, 25)); // NOI18N
        newPropertyPageButton_1.setForeground(new java.awt.Color(255, 255, 255));
        newPropertyPageButton_1.setText("New Property");
        newPropertyPageButton_1.setBorder(null);


        logOutButton_1.setBackground(new Color(236, 77, 55));
        logOutButton_1.setFont(new java.awt.Font("Source Serif Pro Black", 0, 25)); // NOI18N
        logOutButton_1.setForeground(new java.awt.Color(255, 255, 255));
        logOutButton_1.setText("Log Out");
        logOutButton_1.setBorder(null);
        	...
        	sidebarPanelLayout.createParallelGroup(Alignment.LEADING)
        		.addGroup(sidebarPanelLayout.createSequentialGroup()
        			...
        			.addGroup(sidebarPanelLayout.createParallelGroup(Alignment.LEADING)
        				.addComponent(logOutButton_1)
        				.addComponent(newPropertyPageButton_1)
        				.addComponent(managePropertiesButton_1)
        				.addComponent(rentRequestsButton_1)
        				.addComponent(homeButton_1))
        ...
        propertyTypeComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Apartment", "Flat", "Condominium", "Serviced Residence", "Link House", "Cluster House", "Bungalow", "Semi Detached House", "Villa", "Residential Land" }));
        ...
        furnishingComboBox.setModel(new DefaultComboBoxModel(new String[] {"Fully Furnished", "Partially Furnished", "Unfurnished"}));
    ...
    private JButton rentRequestsButton_1;
